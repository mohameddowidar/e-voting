package org.primefaces.barcelona.view.chart;
...
public class ChartJsView implements Serializable {
    ...
    public void createBarModel() {
       ...
       barDataSet.setLabel("My First Dataset");
        ...
        borderColor.add("#0da06e");
        borderColor.add("#07c880");
        borderColor.add("#9ec12b");
        borderColor.add("#ffa600");
        borderColor.add("#008755");
  
        barDataSet.setBorderColor(borderColor);
        barDataSet.setBorderWidth(0);
    ...
    public void createRadarModel() {
        ...
        radarDataSet.setBackgroundColor("rgba(141, 109, 173, 0.2)");
        radarDataSet.setBorderColor("#8d6dad");
        radarDataSet.setPointBackgroundColor("#8d6dad");
        ...
        radarDataSet2.setBackgroundColor("rgba(0, 179, 204, 0.2)");
        radarDataSet2.setBorderColor("#00b3cc");
        radarDataSet2.setPointBackgroundColor("#00b3cc");
